 ...
 * container on the FPrimePacketId parameter, and containers are
 * classified by the qualified *name* of their entries (`FrameRow\d+$`,
 * `PaletteOut`). Commands and the State channel are likewise located by
 * name (`KeyDown` and its component prefix). The component/deployment
 * prefix is discovered, but renaming those channels or commands breaks
 * this display.
 */
